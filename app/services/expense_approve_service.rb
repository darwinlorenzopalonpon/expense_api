class ExpenseApproveService < BaseService
  ...
  def call
    ...
    begin
      ...
      @expense.approve!
      success(message: "Expense approved successfully", data: @expense)
    rescue => e
      error(message: "Failed to approve expense: #{e.message}", type: :unprocessable_entity)
    end
  end
end
